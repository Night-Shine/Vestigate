...
import com.nightshine.vestigate.repository.teams.CustomTeamRepository;
...
@Repository
public interface ProjectsRepository extends MongoRepository<Projects,String>, CustomProjectRepository<Projects, String> {
